                        ...
                        <div className="footer-first">
                            ...
                            <div className="contact-info d-flex-all">
                                <div className="images d-flex-all justify-content-start">
                                    <figure>
                                        <img src="/img/seb.jpg" alt="Contact Images" />
                                    </figure>
                                    <figure>
                                        <img src="/img/sandra.jpg" alt="Contact Images" />
                                    </figure>
                                </div>
                                <p>Ihre Ansprechpartner <span>+49 172 1871489</span></p>
                            </div>
                            <Link href="/contact" className="theme-btn">
                                Kostenfreie Beratung <i className="fa-solid fa-angles-right" />
                            </Link>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6 col-sm-12">
                            <div className="footer-col">
                                <h3>Ihr Bauer Bau Team</h3>
                                <p>Wir freuen uns wenn Sie uns mit Ihren Fragen und Ideen kontaktieren.</p>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col-sm-12">
                            <div className="footer-col">
